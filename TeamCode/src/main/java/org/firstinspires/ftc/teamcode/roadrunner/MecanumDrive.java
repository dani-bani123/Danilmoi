...
public final class MecanumDrive {
    ...
    public MecanumDrive(HardwareMap hardwareMap, Pose2d pose) {
        ...
        leftFront = hardwareMap.get(DcMotorEx.class, "motor Fs");
        leftBack = hardwareMap.get(DcMotorEx.class, "motor Ss");
        rightBack = hardwareMap.get(DcMotorEx.class, "motor Sd");
        rightFront = hardwareMap.get(DcMotorEx.class, "motor Fd");
